    ...
    return(
        <ImageBackground source={require('./../../Assets/Images/D/Bg.png')} style={styles.container}>
            ...
            >
                ...
                <AppText  nol={5}  textAlign="center"  family="Poppins-Regular" size={hp("3.5%")} color="white" Label={"Congratulations"} />
                <AppText  nol={5}  textAlign="center"  family="Poppins-Regular" size={hp("2%")} color="white" Label={"Our Search Parameters have found a drink buddy for you. You can get in touch today"} />
