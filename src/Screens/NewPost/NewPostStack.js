            ...
            <Stack.Navigator initialRouteName="newpost">
                <Stack.Screen 
                    ...
                    options={({ route }) => ({
                        ...
                        headerTitle: props => <Text style={{textAlign:'center', fontSize: 18, color:'black', fontFamily: 'Poppins-SemiBold'}}>New Post</Text>,
                        ...
                        headerRight: ()=>        <View  style={{backgroundColor: '#B01125', borderRadius: 50, borderColor:'white', borderWidth:1, right: 20}}>
                                                        <Image 
                                                            resizeMode='contain' 
