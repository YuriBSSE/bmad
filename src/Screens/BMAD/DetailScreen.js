             ...
             <ScrollView scrollEnabled>
                ...
                <View style={{justifyContent:'space-between', flexDirection:'row', padding: 10, paddingLeft:15, paddingRight:15}}>
                    <View style={{justifyContent:'flex-start', flexDirection:'column', width: wp('40%')}}>
                        ...
                        <AppText nol={3} textAlign="left" family="Poppins-Bold" size={hp("2.3%")} color="black" Label={Data.title} />
                        <View style={{flexDirection:'row',  alignItems:'center',  }}>
                            ...
                            <View style={{padding: 5, top:2, left: 2}}>
                              <AppText nol={1} textAlign="left" family="Poppins-Bold" size={hp("1.8%")} color="black" Label={Data.rating} />
                            </View>
                            <View style={{left: 5, top:2}}>
                                <Text style={{textAlign: 'left', fontFamily:'Poppins-Regular', fontSize: hp('1.7'), color:'black' }}>
                ...
                <View style={{justifyContent:'center', flexDirection:'column', padding: 10, paddingLeft:15, paddingRight:15}}>
                    <AppText nol={lines} textAlign="left" family="Poppins-Regular" size={hp("1.7%")} color="black" Label={Data.description} />
                {
                    !linesCondition ?
                    <TouchableOpacity style={{top: 5}} onPress={()=> ReadMore()}>
                        <AppText nol={1} textAlign="left" family="Poppins-Regular" size={hp("1.7%")} color="#EA2C2E" Label={"Read More"} />
                    </TouchableOpacity>:
                    (
                    <TouchableOpacity style={{top: 5}} onPress={()=> ShowLess()}>
                        <AppText nol={1} textAlign="left" family="Poppins-Regular" size={hp("1.7%")} color="#EA2C2E" Label={"Show Less"} />
                    </TouchableOpacity>
                    )
                }  
                </View>
                <View style={{justifyContent:'flex-start', flexDirection:'row', padding: 10, paddingLeft:15, paddingRight:15, alignItems:'center'}}>
                     ...
                     <AppText nol={2} textAlign="left" family="Poppins-Regular" size={hp("1.6%")} color="black" Label={Data.Address} />
                </View>
                <View style={{height:hp('40%'), top: 10}}>
                    <View style={{padding: 10}}>
                     <AppText nol={2} textAlign="left" family="Poppins-Bold" size={hp("2.3%")} color="black" Label={'Drinks Available'} />
                    </View>
                <FlatList
                        horizontal
                        data={Data.items}
