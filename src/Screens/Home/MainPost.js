            ...
            ListHeaderComponent={
                   <View style={{}} > 
                        ...
                        <View style={{justifyContent: 'flex-start', flexDirection:'row', width: '80%', margin: 8}}>
                                ...
                                />
                                <View style={{flexDirection:'row', padding: 4,justifyContent:'space-between', alignContent:'center', left:5, width: '94%' }}>
                                    <View style={{ justifyContent:'flex-start', flexDirection:'column'}}>
                        ...
                        <View style={{ justifyContent:'flex-start',alignItems:'flex-start',  width: '95%' , margin: 10}}>
                            <AppText  nol={12}  textAlign="left"  family="Poppins-Regular" size={hp("1.9%")} color="black" Label={route.params.description} /> 
                        </View>                                                  
                        </View>
                                <View style={{
