            ...
            <View style={{
                    ...
                    <View style={{flexDirection:'row', padding: 4,justifyContent:'space-between', alignContent:'center', left:5, width: '80%' }}>
                            ...
                            <View style={{flexDirection:'row', justifyContent:'space-around'}}>
                                <View style={{  flexDirection:'row'}}>
                                    ...
                                    <AppText  nol={1}  textAlign="left"  family="Poppins-Regular" size={hp("1.5%")} color="black" Label={TotalLike} />
                                </View>
                                <View style={{  flexDirection:'row', left:5}}>
                                    <View style={{paddingRight: 5}}>
                                        <Icon1 name="message-outline" size={18} color="#B01125" />
                                    </View>
                                    <AppText  nol={1}  textAlign="left"  family="Poppins-Regular" size={hp("1.5%")} color="black" Label={Comment} />
                                </View>
                ...
                <TouchableOpacity 
                    ...
                    <View style={{ justifyContent:'flex-start',alignItems:'flex-start', }}>
                        <AppText  nol={12}  textAlign="left"  family="Poppins-Regular" size={hp("1.9%")} color="black" Label={Description} /> 
                    </View>  
                    </TouchableOpacity>
                </View>
                        ...
                        />
                            ...
                            <View style={{width: '95%', height:0.5, backgroundColor:'black', top:-3}} />            
                       </View>
