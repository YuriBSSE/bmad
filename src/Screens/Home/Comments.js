...
import {
 ...
 const Comment = ({img, name, time, message}) => {
    ...
    return (
          <View style={{ flexDirection:'row', width: '94%', margin: 2, padding: 5, justifyContent:'center', flexDirection:'column',  alignSelf:'center', alignItems:'center'}}>
           <View style={{justifyContent: 'flex-start', flexDirection:'column'}}>
                 ...
                 <View style={{ justifyContent:'flex-start',alignItems:'flex-start', width:'90%' }}>
                      <AppText  nol={12}  textAlign="left"  family="Poppins-Regular" size={hp("1.9%")} color="black" Label={message} /> 
                </View>  
            </View>
         </View>
     )
