 ...
 const MainScreen  = ({navigation}) => {
   ...
   return (
     <View style={styles.container}>
         ...
         <ImageBackground style={styles.backgroundImage} resizeMode='stretch' source={require('./../../Assets/Images/Bg1.png')}>
         <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
             <Animated.View style={[{ display: 'flex',justifyContent: 'center', alignItems: 'center',},moveToTop.getLayout()]}>
             ...
             <Animated.View style={[styles.outerContainer, {opacity: fadeAnim}]}>
                ...
                <Animated.View style={{padding: 30, justifyContent: 'space-between', flexDirection:'row'}}>
                {/* <LoginButton
                ...
                /> */}
                    ...
                    >
                            <Image style={styles.icons} resizeMode="contain" source={require('./../../Assets/Images/Facebook.png')} />
                    </TouchableOpacity>
                    <TouchableOpacity>
                            <Image style={styles.icons}  resizeMode="contain" source={require('./../../Assets/Images/Instagram.png')} />
                    </TouchableOpacity>
                    <TouchableOpacity>
                            <Image style={styles.icons} resizeMode="contain" source={require('./../../Assets/Images/twitter.png')} />
                    </TouchableOpacity>
                </Animated.View>
